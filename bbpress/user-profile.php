...
<div id="bbp-user-profile" class="bbp-user-profile row">
    <h2 class="entry-title profile-name col-lg-12"><?php bbp_displayed_user_field( 'display_name' ); ?></h2>
    <div class="bbp-user-section col-lg-12">
